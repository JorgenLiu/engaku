...
## Directory Structure
    ...
    src/engaku/templates/instructions/  Stub .instructions.md files — lessons.instructions.md (applyTo: **)
    src/engaku/templates/skills/        Bundled skills (systematic-debugging, verification-before-completion, frontend-design, proactive-initiative, mcp-builder, doc-coauthoring, brainstorming)
