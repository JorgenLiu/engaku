...
tools: ['agent', 'edit', 'read', 'search', 'execute', 'selection', 'read/problems', 'search/changes', 'search/codebase', 'search/usages', 'vscode/askQuestions', 'chrome-devtools/*', 'context7/*', 'dbhub/*']
hooks:
  Stop:
    - type: command
